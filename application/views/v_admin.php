...
<html lang="en"><head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/admin/assets/admin/lib/font-awesome/css/font-awesome.css')?>">

    <script src="<?php echo base_url('assets/admin/lib/jquery-1.11.1.min.js') ?>" type="text/javascript"></script>

        <script src="<?php echo base_url('assets/admin/lib/jQuery-Knob/js/jquery.knob.js')?>" type="text/javascript"></script>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/admin/stylesheets/premium.css')?>">
